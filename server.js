...
app.post("/login", (req, res) => {
  ...
  if (req.body.username.trim() == "") errors = ["Nom d'utilisateur ou Mot de passe Invalides."]
  if (req.body.password == "") errors = ["Nom d'utilisateur ou Mot de passe Invalides."]
  ...
  if (!userInQuestion) {
    errors = ["Nom d'utilisateur ou Mot de passe Invalides."]
    return res.render("login", { errors })
  }
...
function sharedPostValidation(req) {
  ...
  if (!req.body.title) errors.push("Vous devez fournir un Titre à votre post")
  if (!req.body.body) errors.push("Vous devez fournir du contenu à votre post")
